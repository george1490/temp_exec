     ...
     public:
      ...
      void run_some() noexcept {
        ...
        while (!__result.__ready.empty()) {
          __n_total_submitted_ -= __completion_queue_.complete(
            static_cast<__task_queue&&>(__result.__ready));
      ...
      class __run_sender {
       ...
       private:
        ...
        template <
          ...
          typename _Rcvr, std::enable_if_t<stdexec::receiver_of<_Rcvr, completion_signatures>, int> = 0>
...
#    else
        ...
        static constexpr ::itimerspec __duration_to_timespec(
          std::chrono::nanoseconds __nsec) noexcept {
     ...
     public:
      ...
      class __schedule_sender {
       ...
       private:
        ...
        template <typename _Receiver, std::enable_if_t<stdexec::receiver_of<_Receiver, __completion_sigs>, int> = 0>
        friend auto
